describe('Laravel Project Testing', () => {
    ...
    //     await testLogin('sthevanimanurung29@gmail.com', 'sthevani', 'http://127.0.0.1:8000/login');
    //     await pauseFor5Seconds();
    // });
  
    // it('should not login with invalid email and valid password', async () => {
    //     await testLogin('sthevani@gmail.com', '29Maret2002', 'http://127.0.0.1:8000/login');
    //     await pauseFor5Seconds();
    // });
  
    // it('should not login with invalid email and invalid password', async () => {
    //     await testLogin('sthevani@gmail.com', 'sthevani', 'http://127.0.0.1:8000/login');
    //     await pauseFor5Seconds();
    // });
  
    // it('should not login with empty email and valid password', async () => {
    //     await testLogin('', '29Maret2002', 'http://127.0.0.1:8000/login');
    //     await pauseFor5Seconds();
    // });
  
    // it('should not login with valid email and empty password', async () => {
    //     await testLogin('sthevanimanurung29@gmail.com', '', 'http://127.0.0.1:8000/login');
    //     await pauseFor5Seconds();
    // });
  
    it('should login with valid email and valid password', async () => {
        await testLogin('sthevanimanurung29@gmail.com', '29Maret2002', 'http://127.0.0.1:8000/');
        await pauseFor5Seconds();
    });
  });
